...
public sealed class UpdateDeviceCommand(Guid id, Guid? hubId, string name, Os os, RestProtocol? restProtocol, ushort? restPort, Guid organizationId, Guid userId)

...
internal sealed class UpdateOrganizationHandler(ITunnelingRepository tunnelingRepository) : IRequestHandler<UpdateOrganizationCommand, OperationResult<Organization>>
{

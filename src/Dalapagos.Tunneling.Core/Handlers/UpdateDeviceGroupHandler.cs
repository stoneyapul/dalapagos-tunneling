...
internal sealed class UpdateDeviceGroupHandler(ITunnelingRepository tunnelingRepository) : HandlerBase<UpdateDeviceGroupCommand, OperationResult<DeviceGroup>>
{
